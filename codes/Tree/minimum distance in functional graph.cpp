// Given a functional graph (each node has exactly one outgoing edge), answer
// queries about the minimum distance between two nodes, or determine that
// it's impossible to get from one to the other.
// There are three cases:
// 1. Both in Tree
// 2. Both in Cycle
// 3. One in Tree, one in Cycle
